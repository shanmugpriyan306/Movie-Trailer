...
public class VideoPlayback extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mMovieName[STONES] = "http://mastbaumbishop.wikispaces.com/file/view/sample.m4v/77739109/sample.m4v";
		mMovieName[CHIPS] = "http://mastbaumbishop.wikispaces.com/file/view/sample.m4v/77739109/sample.m4v";
	...
	private void setupStartScreen() {
		...
		mStartupView = getLayoutInflater().inflate(R.layout.startup_screen,
				null);
		...
		ImageView background_view = (ImageView) findViewById(R.id.background_view);
